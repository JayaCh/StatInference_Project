...
```{r}
sVariance #distribution variance
```

```{r}
tVariance # theoretical variance
```

The variance of the distribution is `sVariance` and the theoretical variance of the distribution is `tVariance` and these values are close. It can be expected that as we increase the number of simulations, we will get closer to the theoretical values.
